...
- [x] Faza 17: Inteligentny import ze zrzutami bankowymi (CSV). Silnik uniwersalnego mapowania kolumn (Data, Tytuł, Kwota) i wbudowany parser PapaParse eliminujący potrzebę własnego serwera.
- [x] Faza 18: Zaawansowane Raportowanie (Roczne Cash-flow), 3 zaawansowane wykresy (Recharts) do analityki finansowej.
